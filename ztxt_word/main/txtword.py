...
def process_text_to_word(
    text, 
    font_path=r"D:\Nkt\workwork\1Programing\Text to word site\ztxt_word\main\static\fonts\Salavat-Font4You.ttf", 
    font_size=30, 
    notebook_image_path=r"D:\Nkt\workwork\1Programing\Text to word site\ztxt_word\main\static\img\plate.jpg",
    padding_left_odd=65, 
